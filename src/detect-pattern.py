...
def compareImage(pattern_url, photo_b64):
    ''' Read images in '''
    # Read [pattern] & convert to grayscale
    refFilename = "form.jpg"
    imPattern = io.imread(pattern_url)
    #imPattern = cv2.imread("https://pbs.twimg.com/profile_images/378800000822867536/3f5a00acf72df93528b6bb7cd0a4fd0c_400x400.jpeg", cv2.IMREAD_COLOR)
    imPatternGray = cv2.cvtColor(imPattern, cv2.COLOR_BGR2GRAY)
     
    # Read [photo] & convert to grayscale
    imFilename = "scanned-form.jpg"
    imPhoto = imageio.imread(IO.BytesIO(base64.b64decode(photo_b64)))
    # imPhoto = io.imread('https://res.cloudinary.com/legitmaxwu/image/upload/v1537039241/owngszpvhskitgwthiti.png')
    #imPhoto = cv2.imread("https://vignette.wikia.nocookie.net/joke-battles/images/4/40/18360-doge-doge-simple.jpg/revision/latest?cb=20151209161638", cv2.IMREAD_COLOR)
    ...
    ''' Output! '''
    print("Keypoints Photo: " + str(len(kpAligned)))
    print("Keypoints Pattern: " + str(len(kpPattern)))
